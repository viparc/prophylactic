...
viparc %>% 
  dplyr::mutate(amu = make_exposure(., c("colistin_use", "oxytetracycline_use")),
                disease = make_outcome(., c("malaise", "diarrhoea"), 2)) %>% 
...
(tmp <- viparc %>% 
  dplyr::mutate(amu = make_exposure(., c("colistin_use", "oxytetracycline_use")),
                disease = make_outcome(., c("malaise", "diarrhoea"), 2),
                amu_first_weeks = first_weeks(., c("colistin_use", "oxytetracycline_use")),
                amu_observation = make_outcome(., c("colistin_use", "oxytetracycline_use"), 2)) %>% 
  dplyr::filter(prophylactic(., c("malaise", "diarrhoea"),
                             c("colistin_use", "oxytetracycline_use"), 2, 2)) %>% 
